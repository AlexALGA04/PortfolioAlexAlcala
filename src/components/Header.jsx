...
function Header() {
  return (
    <header className='flex'>
        <nav>
            <ul className='flex text-white border-1 border-[#A855F7] p-3 px-10 rounded-full'>
              <li className='mr-10'><a href="#inicio">Inicio</a></li>
              <li className='mr-10'><a href="#habilidades">Habilidades</a></li>
              <li className='mr-10'><a href="#proyectos">Proyectos</a></li>
